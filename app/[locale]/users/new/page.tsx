...
export default async function NewUser({ params }: { params: Promise<{ locale: string }> }) {
  ...
  return (
    <div className="max-w-sm w-full mx-auto p-3 sm:p-6 bg-white rounded-lg shadow-md mt-2 mb-16 min-h-screen flex flex-col justify-start">
      ...
      <Form action={createUser} className="space-y-4 sm:space-y-6">
        <div>
          <label
            htmlFor="username"
            className="flex text-base sm:text-lg font-medium mb-1 sm:mb-2 items-center text-gray-700"
          >
            {t('username')}
        ...
        <div>
          <label htmlFor="name" className="block text-base sm:text-lg font-medium mb-1 sm:mb-2 text-gray-700">
            {t('name')}
          </label>
          <input
            type="text"
        ...
        <div>
          <label htmlFor="phone" className="block text-base sm:text-lg font-medium mb-1 sm:mb-2 text-gray-700">
            {t('phone')}
          </label>
          <input
            type="tel"
