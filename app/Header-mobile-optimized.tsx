...
export default function HeaderMobileOptimized() {
  ...
  return (
    <div className="w-full bg-white shadow-md py-4 px-4">
          ...
          {isLoading ? (
            ...
            <div className="relative" ref={userMenuRef}>
              ...
              >
                ...
                <span className="ml-2 text-gray-700 max-w-[80px] truncate text-sm">
      ...
      {/* 第三行：导航链接 */}
      <div className="flex items-center justify-center space-x-8 pt-3 border-t border-gray-200">
        <Link
          href={`/${locale}`}
        ...
        {currentUser && (
          ...
          >
            ...
            <span className="text-xs font-medium">{t('post')}</span>
          </Link>
        )}
      </div>
    </div>
