...
export const config = {
  matcher: [
     ...
     */
    '/((?!_next/static|_next/image|api|favicon.ico|manifest.json|service-worker.js|pwa-install.bundle.js|nsfw-model|privacy.html|icons/|screenshots/|.*\\.(?:png|jpg|jpeg|gif|svg|ico|webp|json|js|css|woff|woff2|ttf|eot|txt)).*)',
  ],
};
